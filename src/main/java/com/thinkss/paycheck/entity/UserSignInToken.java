...
public class UserSignInToken {
	...
	public UserSignInToken(Boolean  status, Boolean  verifiedUser, String message) {
		...
		@JsonCreator
		public UserSignInToken( @JsonProperty("status")Boolean  status, @JsonProperty("message") String message) {
			this.status = status;
			this.message = message;
		}
		@JsonCreator
		public UserSignInToken(@JsonProperty("status")Boolean  status, @JsonProperty("verifiedUser")Boolean  verifiedUser, @JsonProperty("message")String message) {
			this.status = status;
			this.verifiedUser = verifiedUser;
			this.message = message;
		}
		@JsonCreator
		public UserSignInToken( @JsonProperty("status")Boolean  status, @JsonProperty("profilePic") String profilePic, @JsonProperty("message") String message) {
			this.status = status;
			this.profilePic = profilePic;
			this.message = message;
		}
		@JsonCreator
		public UserSignInToken(
		...
		@JsonCreator
		public UserSignInToken( @JsonProperty("status")Boolean  status, @JsonProperty("kycFrontPic") String kycFrontPic, @JsonProperty("kycBackPic") String kycBackPic, @JsonProperty("message") String message) {
			this.status = status;
			this.kycFrontPic = kycFrontPic;
			this.kycBackPic = kycBackPic;
			this.message = message;
		...
		@JsonCreator
		public UserSignInToken(@JsonProperty("status")Boolean  status,@JsonProperty("isfacebookAccount")Boolean  isfacebookAccount, @JsonProperty("idProof")Boolean  idProof, @JsonProperty("verifiedUser")Boolean  verifiedUser, @JsonProperty("message")String message ,
		...
		@JsonCreator
		public UserSignInToken(@JsonProperty("access_token")String access_token,@JsonProperty("expires_in") int expires_in, @JsonProperty("id")Long id, @JsonProperty("status")Boolean   status, @JsonProperty("firstName")String firstName,
		...
		@JsonCreator
		public UserSignInToken(@JsonProperty("access_token")String access_token,@JsonProperty("expires_in") int expires_in, @JsonProperty("id")Long id, @JsonProperty("status")Boolean   status, 
